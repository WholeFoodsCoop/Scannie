...
class ProductsUpdatedByUserReport extends ScancoordDispatch
{
    ...
    {           
        ...
        $query = $dbc->prepare("
            ...
            from prodUpdate 
            where User = 2278 
                and modified between '2016-10-17' and '2016-10-17 23:59:59' 
            group by upc;");
            ...
            <div class="text-center container">
                <form class ="form-inline"  method="get" > 
                    ...
                    <div class="form-group">    
                        <input type="date" class="form-control" name="startDate" placeholder="start date" autofocus>
                    </div>
                    <div class="form-group">    
                        <input type="date" class="form-control" name="endDate" placeholder="end date" autofocus>
                    </div>
                    <div class="form-group">
