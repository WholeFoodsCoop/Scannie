...
if (!function_exists("ADONewConnection")) {
    if (file_exists(dirname(__FILE__) . '/adodb5/adodb.inc.php')) {
        include(dirname(__FILE__) . '/adodb5/adodb.inc.php');
    } 
}
require(dirname(__FILE__) . '/sql/DialectAdapter.php');
if(!function_exists("MysqlAdapter")) {
    include(dirname(__FILE__) . '/sql/MysqlAdapter.php');
}
if(!function_exists("ConnectionWrapper")) {
    include(dirname(__FILE__) . '/sql/ConnectionWrapper.php');
}
if(!function_exists("MssqlAdapter")) {
    include(dirname(__FILE__) . '/sql/MssqlAdapter.php');
}
if(!function_exists("SqliteAdapter")) {
    include(dirname(__FILE__) . '/sql/SqliteAdapter.php');
}
if(!function_exists("Lib")) {
    include(dirname(__FILE__) . '/sql/Lib.php');
}
/*
if(!function_exists("TestManager")) {
    include(dirname(__FILE__) . '/sql/TestManager.php');
}*/
/**
 @class SQLManager
...
class SQLManager 
{
    ...
    */
    ...
    protected $adapter_map = array(
        'mysql'     => 'MysqlAdapter',
        'mysqli'    => 'MysqlAdapter',
        'pdo_mysql' => 'MysqlAdapter',
        'pdo'       => 'MysqlAdapter',
        'mssql'     => 'MssqlAdapter',
        'pgsql'     => 'PgsqlAdapter',
        'pdo_pgsql'     => 'PgsqlAdapter',
