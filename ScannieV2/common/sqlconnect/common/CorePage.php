...
class CorePage 
{
    ...
    */
    ...
    public function baseTest($phpunit)
    {
        ...
        $this->connection = new sqlconnect\SQLManager($FANNIE_SERVER, $FANNIE_SERVER_DBMS, $FANNIE_OP_DB, $FANNIE_SERVER_USER, $FANNIE_SERVER_PW, true);
