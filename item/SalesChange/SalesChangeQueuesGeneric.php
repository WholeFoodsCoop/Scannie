...
if($_SESSION['store_id'])
{
    ...
    echo "<h1 align='center'>Generic Signs Needed</h1>";
    ...
    for ($i=0; $i<count($upc); $i++) {
        if ($upc[$i] >= 0) {
            ...
            echo "<td>" . $batch[$i] . "</td>";    
            echo "<td><button class=\"btn btn-default\" type=\"button\" onclick=\"sendToQueue(this, '{$upc[$i]}', -1, '{$_SESSION['session']}'); return false;\">Remove</button></td>";    
        }
    }
    echo "</table>";    
    } else {
