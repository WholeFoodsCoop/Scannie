...
$query = "SELECT 
    ...
    FROM products AS p
        ...
        RIGHT JOIN prodUpdate AS pu ON pu.upc=p.upc
	WHERE p.upc=1356200166
        or p.upc=1356200168
        or p.upc=1356200167
        or p.upc=4256301756
        or p.upc=4256301755
        or p.upc=4023220854
        or p.upc=4023220855
        or p.upc=82969600126
        or p.upc=7260904347
        or p.upc=7260904346
        or p.upc=7260904349
        or p.upc=7260904348
        or p.upc=7260904345
        or p.upc=85692000514
        or p.upc=85692000503
        or p.upc=85692000506
        or p.upc=85692000504
        or p.upc=85692000504
        or p.upc=85692000502
        or p.upc=85692000505
        or p.upc=85692000500
        or p.upc=85692000501
        or p.upc=74447300026
        or p.upc=74447300028
        or p.upc=74447300027
        or p.upc=81668001031
        or p.upc=7912610454
        or p.upc=7912610457
        or p.upc=7912610460    
        GROUP BY p.upc
...
while ($row = mysql_fetch_assoc($result)) {
        ...
        /*  UNCOMMENT IF YOU WOULD LIKE TAGS SORTED / LABELED BY ISLE
...
$isleCheck = 0;
$subIsleCheck = 0;
//  Range 'j' controls how many copies of each shelf tag you would like to print.
//  Usefuld for printing entire sheets of the same tag. 
//  for ($j=0; $j<1; $j++) <- wrap around just the following 'foreach'
...
//  change to $sortedTagsMarked to print sorted / marked tags
WFC_New($tags, $offset=0);
