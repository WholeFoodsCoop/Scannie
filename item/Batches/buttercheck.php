...
<h4 align="center">UNFI Butter Cost / Price Scan</h4>
...
$query = "select p.upc, p.brand, p.description, p.cost, p.normal_price, p.price_rule_id from products as p where p.department = 26 group by p.upc;";
